...
namespace Vanta.UI
{
    public sealed class VantaHud : MonoBehaviour
    {
        ...
        private void OnGUI()
        {
            ...
            GUI.Label(new Rect(20, 74, 620, 24), "WASD Move   SHIFT Sprint   CTRL Crouch   SPACE Jump   RMB Aim   LMB Fire   R Reload   F Melee   B Bullet Time   E Interact   ESC Pause", body);
